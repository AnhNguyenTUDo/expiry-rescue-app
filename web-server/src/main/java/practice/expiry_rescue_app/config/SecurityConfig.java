                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(org.springframework.http.HttpMethod.GET,
                                                                ...
                                                                "/api/v1/products/inventory/supermarket/{supermarketId}/product-master/{productMasterId}",
                                                                "/api/v1/products/inventory/product-master/{productMasterId}",
                                                                "/api/v1/products/inventory/product-master/{productMasterId}/other-locations",
