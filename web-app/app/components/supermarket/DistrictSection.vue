<template>
  <div class="mb-8">
    ...
    <!-- Empty state -->
    <div v-if="stores.length === 0" class="flex flex-col items-center justify-center py-10 text-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24" class="mb-3">
      ...
      <p class="text-gray-500 text-sm">No supermarkets found in <span class="font-semibold">{{ districtName }}</span>.</p>
    </div>
