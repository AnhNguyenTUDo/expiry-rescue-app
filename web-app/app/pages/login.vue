<template>
  <div class="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-800 to-cyan-900 flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -right-40 w-80 h-80 bg-emerald-500/20 rounded-full blur-3xl"></div>
    ...
    <div class="relative w-full max-w-md">
      <!-- Glassmorphism card -->
      <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 transition-all duration-500 hover:bg-white/15">
        
        <!-- Logo and Title -->
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-400 to-cyan-400 rounded-2xl mb-4 shadow-lg shadow-emerald-500/30">
        ...
        <!-- Error Message -->
        <div v-if="authStore.error" class="mb-6 p-4 bg-red-500/20 border border-red-400/30 rounded-xl backdrop-blur-sm">
        ...
        <div class="space-y-4">
          ...
          <button
            ...
            :disabled="isLoading"
            class="group relative w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-gray-50 rounded-xl text-gray-700 font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
          >
            <div class="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/5 to-red-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
          ...
          <button
            ...
            :disabled="isLoading"
            class="group relative w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#1877F2] hover:bg-[#166FE5] rounded-xl text-white font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
          >
            ...
            <div v-if="isLoading && loginProvider === 'facebook'" class="absolute right-4">
        ...
        <form @submit.prevent="handleEmailLogin" class="space-y-4">
          <div>
            <label for="email" class="block text-sm font-medium text-emerald-200/80 mb-2">Email</label>
            <input
              type="email"
              id="email"
              v-model="email"
          ...
          <div>
            <label for="password" class="block text-sm font-medium text-emerald-200/80 mb-2">Password</label>
            <input
              type="password"
              id="password"
              v-model="password"
        ...
        <div class="mt-8 text-center">
          <p class="text-emerald-200/60 text-sm">
            ...
            <a href="#" class="text-emerald-400 hover:text-emerald-300 transition-colors duration-300">Sign up</a>
          </p>
        </div>
      </div>
